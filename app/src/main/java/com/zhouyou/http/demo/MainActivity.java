...
import com.zhouyou.http.demo.model.UserResult;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onPost(View view) {
        ...
        String paramenter="{\"patientPhone\":\"15521377484\",\"patientName\":\"测试1556\",\"sex\":\"\",\"birthday\":\"\",\"identification\":\"\"}";
        String commdata="{\"phone\":\"15521377484\",\"userName\":\"测试155\",\"userRole\":\"patient\",\"deviceToken\":\"\",\"systemtype\":\"android6.0.1\",\"model\":\"Xiaomi Redmi \n" +
                "4X\",\"packageVesion\":\"3.0.8\",\"session\":\"4BAA4C2DE5A6DE5E37552AD4EC339B70\"}";
        EasyHttp.post("app/patientUser/modifyPatientUserInfo.action")
                .params("parameter", paramenter)
                .params("equipmentData",commdata)
                .accessToken(true)
                .timeStamp(true)
                .execute(new ProgressDialogCallBack<UserResult>(mProgressDialog, true, true) {
                    @Override
                    public void onError(ApiException e) {
                        showToast(e.getMessage());
                    }
                    ...
                    public void onSuccess(UserResult userResult) {
                        Toast.makeText(MainActivity.this, userResult.getPatientUser().getLoginId(), Toast.LENGTH_SHORT).show();
                    }
